...
## Project Structure
    ...
    ├── testapiautoconnect_116852  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116852`
...
2. Clone this repo and `cd testapiautoconnect_116852`
